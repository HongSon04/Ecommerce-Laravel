...
class SliderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('banner', function ($query) {
                return '<img src="' . asset($query->banner) . '" style="width: 100px; height: 100px;border-radius: 5px;">';
            })
            ->editColumn('status', function ($query) {
                $active = "<span class='badge badge-success'>Hiển Thị</span>";
                $inactive = "<span class='badge badge-danger'>Ẩn</span>";
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id'),
            Column::make('banner')->title('Ảnh'),
            Column::make('title')->title('Tiêu đề'),
            Column::make('type')->title('Kiểu'),
            Column::make('starting_price')->title('Giá'),
            ...
            Column::computed('action')
                ...
                ->printable(false)
                ->width(100)
                ->addClass('text-center')->title('Khác'),
        ];
    }
